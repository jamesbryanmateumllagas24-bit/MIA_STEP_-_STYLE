...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 07:38 AM
...
(1, 'Isabel Mayelin Arickx', 'Stacruz, Polangui, Albay', 'IMarickx@email.com', 'IMA01', 'IM101010', 'BLACK DOLLSHOES, 269 FORMAL SANDALS, 499', 2, 'Processing', 0),
...
(120, '', '', '', 'JB', '', 'bermido shoes x1', 1, 'Processing', 0),
...
(135, '', '', '', 'JB', '', 'Elegant Red High Heels x1', 1, 'Processing', 0),
(136, '', '', '', 'JB', '', 'Hiking Boots x1', 1, 'Processing', 0),
(137, '', '', '', 'bermido', '', 'Elegant Red High Heels x1', 1, 'Processing', 0),
(138, '', '', '', 'bermido', '', 'Elegant Red High Heels x1', 1, 'Processing', 0),
(139, '', '', '', 'bermido', '', 'NIKE Lebron 20 x1', 1, 'Processing', 0),
(140, '', '', '', 'bermido', '', 'Elegant Red High Heels x1', 1, 'Processing', 0),
...
(43, 'john mark', 'Polangui', 'Markbermido574@email.com', 'Dan', '$2y$10$79iCVMYEvwDnC2.X241wmOV7odaVziBSf4HKPn/eliNN9OkNrbaqC'),
...
--
ALTER TABLE `orders`
  MODIFY `order_numbers` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
